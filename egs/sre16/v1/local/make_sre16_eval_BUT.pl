...
open(KEY, "<$db_base/../download/sre16_evaluation_key/docs/sre16_eval_trial_key.tsv") || die "Could not open trials file $db_base/../download/sre16_evaluation_key/docs/sre16_eval_trial_key.tsv.  It might be located somewhere else in your distribution.";
open(SEG_KEY, "<$db_base/../download/sre16_evaluation_key/docs/sre16_eval_segment_key.tsv") || die "Could not open trials file $db_base/../download/sre16_evaluation_key/docs/sre16_eval_segment_key.tsv.  It might be located somewhere else in your distribution.";
open(LANG_KEY, "<$db_base/../download/sre16_evaluation_key/metadata/calls.tsv") || die "Could not open trials file $db_base/../download/sre16_evaluation_key/metadata/calls.tsv.  It might be located somewhere else in your distribution.";
