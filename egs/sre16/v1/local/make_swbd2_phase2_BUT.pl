...
$db_base = "$db_base/data/audio";
open(CS, "<$db_base/../../doc/callstat.tbl") || die  "Could not open $db_base/DISC1/doc/callstat.tbl";
open(CI, "<$db_base/../../doc/callinfo.tbl") || die  "Could not open $db_base/DISC1/doc/callinfo.tbl";
