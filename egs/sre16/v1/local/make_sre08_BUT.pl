...
if (@ARGV != 4) {
  print STDERR "Usage: $0 <path-to-SRE08-key> <path-to-SRE08-test> <path-to-SRE08-train> <path-to-output>\n";
  print STDERR "e.g. $0 /export/corpora/LDC/LDC2011S08 /export/corpora/LDC/LDC2011S05 data/\n";
  exit(1);
}
($db_base_key, $db_base_test, $db_base_train, $out_dir) = @ARGV;
...
if (! -d "$db_base_key/") {
  print STDERR "Directory $db_base_key/ doesn't exist\n";
  exit(1);
}
...
%seg2sph = ();
open(TRIALS, "<$db_base_key/NIST_SRE08_KEYS.v0.1/trial-keys/NIST_SRE08_short2-short3.trial.key") || die "Could not open $db_base_key/NIST_SRE08_KEYS.v0.1/trial-keys/NIST_SRE08_short2-short3.trial.key";
open(MODELS, "<$db_base_key/NIST_SRE08_KEYS.v0.1/model-keys/NIST_SRE08_short2.model.key") || die "Could not open $db_base_key/NIST_SRE08_KEYS.v0.1/model-keys/NIST_SRE08_short2.model.key";
