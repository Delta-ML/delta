...
config_file=conf/multimodal-align-emotion.yml
...
#5. generate vocab and embedding
if [[ $stage -le 5 && $stop_stage -ge 5 ]]; then
    echo "generate vocab and embedding"
    wget -P ./data http://nlp.stanford.edu/data/glove.42B.300d.zip
    unzip ./data/glove.42B.300d
    python3 local/python/generate_vocab.py data/dump/all data/vocab.txt 1 \
    data/glove.42B.300d.txt glove.min.pkl || exit 1
fi
