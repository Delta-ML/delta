...
#ifndef DELTA_LAYERS_OPS_KERNELS_MFCC_MEL_FILTERBANK_H_
#define DELTA_LAYERS_OPS_KERNELS_MFCC_MEL_FILTERBANK_H_
...
#endif  // DELTA_LAYERS_OPS_KERNELS_MFCC_MEL_FILTERBANK_H_
