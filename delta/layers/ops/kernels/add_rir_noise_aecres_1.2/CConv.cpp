...
int CConv::ConvProcess(short* pOrigInputData, long lDataLength, double* ppRIR, long lRIRLength, short* pOutputData)
{
    ...
    for(int ii = 0; ii < SegNum; ii++)
    {
        ...
        for(int jj = 0; jj < nBlockLength; jj++)
        {
            X[jj + nBlockLength].real = (double)(pOrigInputData[ii * nBlockLength + jj]);
        ...
        for(int jj = 0; jj < nBlockLength; jj++)
        {
            pFloatData[ii * nBlockLength + jj] = XData[jj + nBlockLength].real / nFFTLength;
        }
    }
    if(SegNum * nBlockLength < lDataLength)
    {
        ...
        {
            X[jj + nBlockLength].real = (double)(pOrigInputData[SegNum * nBlockLength + jj]);
            X[jj + nBlockLength].image = 0.0;
        }
        for(int jj = lDataLength - SegNum * nBlockLength; jj < nBlockLength; jj++)
        {
        ...
        for(int jj = 0; jj < lDataLength - SegNum * nBlockLength; jj++)
        {
            pFloatData[SegNum * nBlockLength + jj] = XData[jj + nBlockLength].real / nFFTLength;
        }
    }
